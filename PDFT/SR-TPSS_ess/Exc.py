...
mol_dft.xc = 'tpss'
dma, dmb = mol_dft.get_init_guess()
dmb[:2, :2] = 0 
dm = (dma, dmb)
mol_dft.kernel(dm)
...
CH1_geo = gto.M(atom=[
        ['C', (-0.72280, 0.00130, -0.72210)],
        ['ghost-C', (-0.72210, -0.00660, 0.72280)],
        ['ghost-C', (0.72280, -0.00130, 0.72210)],
        ['ghost-C', (0.72210, 0.00660, -0.72280)],
        ['H', (-1.49120, 0.00270, -1.48980)],
        ['ghost-H', (-1.48980, -0.01360, 1.49120)],
        ['ghost-H', (1.49120, -0.00270, 1.48980)],
        ['ghost-H', (1.48980, 0.01360, -1.49120)],
],
unit='ANG', basis={'C': basis, 'ghost-C': ghostbasis, 'H': basis, 'ghost-H': ghostbasis}, spin=3) 
CH1dft = FragmentDFT(CH1_geo, 'tpss')
CH1dft.kernel()
...
unit='ANG', basis={'C': basis, 'ghost-C': ghostbasis, 'H': basis, 'ghost-H': ghostbasis}, spin=3)  
CH2dft = FragmentDFT(CH2_geo, 'tpss')
CH2dft.kernel()
...
unit='ANG', basis={'C': basis, 'ghost-C': ghostbasis, 'H': basis, 'ghost-H': ghostbasis}, spin=3) 
CH3dft = FragmentDFT(CH3_geo, 'tpss')
CH3dft.kernel()
...
unit='ANG', basis={'C': basis, 'ghost-C': ghostbasis, 'H': basis, 'ghost-H': ghostbasis}, spin=3) 
CH4dft = FragmentDFT(CH4_geo, 'tpss')
CH4dft.kernel()
...
naCH1 = dft.numint.eval_rho(mol_geo, phiCH1, DaCH1, xctype='mgga')
nbCH1 = dft.numint.eval_rho(mol_geo, phiCH1, DbCH1, xctype='mgga')
naCH2 = dft.numint.eval_rho(mol_geo, phiCH2, DaCH2, xctype='mgga')
nbCH2 = dft.numint.eval_rho(mol_geo, phiCH2, DbCH2, xctype='mgga')
naCH3 = dft.numint.eval_rho(mol_geo, phiCH3, DaCH3, xctype='mgga')
nbCH3 = dft.numint.eval_rho(mol_geo, phiCH3, DbCH3, xctype='mgga')
naCH4 = dft.numint.eval_rho(mol_geo, phiCH4, DaCH4, xctype='mgga')
nbCH4 = dft.numint.eval_rho(mol_geo, phiCH4, DbCH4, xctype='mgga')
...
exc, vxc, fxc, kxc = dft.libxc.eval_xc('tpss', ntot, spin=1, relativity=0, deriv=1, omega=None, verbose=None)
Exctot = np.sum((nfa[0]+nfb[0])*w * exc)
exc1, vxc1, fxc1, kxc1 = dft.libxc.eval_xc('tpss', n1, spin=1, relativity=0, deriv=1, omega=None, verbose=None)
ExcCH1 = np.sum((naCH1[0]+nbCH1[0])*w * exc1)
exc2, vxc2, fxc2, kxc2 = dft.libxc.eval_xc('tpss', n2, spin=1, relativity=0, deriv=1, omega=None, verbose=None)
ExcCH2 = np.sum((naCH2[0]+nbCH2[0])*w * exc2)
exc3, vxc3, fxc3, kxc3 = dft.libxc.eval_xc('tpss', n3, spin=1, relativity=0, deriv=1, omega=None, verbose=None)
ExcCH3 = np.sum((naCH3[0]+nbCH3[0])*w * exc3)
exc4, vxc4, fxc4, kxc4 = dft.libxc.eval_xc('tpss', n4, spin=1, relativity=0, deriv=1, omega=None, verbose=None)
ExcCH4 = np.sum((naCH4[0]+nbCH4[0])*w * exc4)
Excnad = Exctot - ExcCH1 - ExcCH2 - ExcCH3 - ExcCH4
print(f"M={M:.2f} Total XC energy={Exctot:.5f} Non-additive XC energy={Excnad:.5f}.")
