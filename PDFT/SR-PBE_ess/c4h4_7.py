...
H          1.47980       -0.00280        1.50160
H          1.47840        0.01360       -1.50300 """, unit='ANG', basis=basis)

mol_dft = dft.UKS(mol_geo)
mol_dft.xc = 'pbe'
dm = mol_dft.from_chk('c4h4_7.chk')
mol_dft.kernel(dm)
...
CH1_geo = gto.M(atom=[
        ['C', (-0.70830, 0.00140, -0.73700)],
        ['ghost-C', (-0.70760, -0.00660, 0.73760)],
        ['ghost-C', (0.70830, -0.00140, 0.73700)],
        ['ghost-C', (0.70760, 0.00660, -0.73760)],
        ['H', (-1.47980, 0.00280, -1.50160)],
        ['ghost-H', (-1.47840, -0.01360, 1.50300)],
        ['ghost-H', (1.47980, -0.00280, 1.50160)],
        ['ghost-H', (1.47840, 0.01360, -1.50300)],
],
