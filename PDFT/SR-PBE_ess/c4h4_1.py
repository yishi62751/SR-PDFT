...
mol_dft.xc = 'pbe'
dm = mol_dft.from_chk('c4h4_1.chk')
mol_dft.kernel(dm)
...
CH1_geo = gto.M(atom=[
        ['C', (-0.66970, 0.00180, -0.78430)],
        ['ghost-C', (-0.66890, -0.00670, 0.78500)],
        ['ghost-C', (0.66970, -0.00180, 0.78430)],
        ['ghost-C', (0.66890, 0.00670, -0.78500)],
        ['H', (-1.44600, 0.00310, -1.54560)],
        ['ghost-H', (-1.44450, -0.01370, 1.54690)],
        ['ghost-H', (1.44600, -0.00310, 1.54560)],
        ['ghost-H', (1.44450, 0.01370, -1.54690)],
],
