...
CH1dft = FragmentDFT(CH1_geo, 'pbe')
CH1dft.kernel()
...
unit='ANG', basis={'C': basis, 'ghost-C': ghostbasis, 'H': basis, 'ghost-H': ghostbasis}, spin=3)  
CH2dft = FragmentDFT(CH2_geo, 'pbe')
CH2dft.kernel()
...
unit='ANG', basis={'C': basis, 'ghost-C': ghostbasis, 'H': basis, 'ghost-H': ghostbasis}, spin=3) 
CH3dft = FragmentDFT(CH3_geo, 'pbe')
CH3dft.kernel()
...
unit='ANG', basis={'C': basis, 'ghost-C': ghostbasis, 'H': basis, 'ghost-H': ghostbasis}, spin=3) 
CH4dft = FragmentDFT(CH4_geo, 'pbe')
CH4dft.kernel()
...
naCH1 = dft.numint.eval_rho(mol_geo, phiCH1, DaCH1, xctype='gga')
nbCH1 = dft.numint.eval_rho(mol_geo, phiCH1, DbCH1, xctype='gga')
naCH2 = dft.numint.eval_rho(mol_geo, phiCH2, DaCH2, xctype='gga')
nbCH2 = dft.numint.eval_rho(mol_geo, phiCH2, DbCH2, xctype='gga')
naCH3 = dft.numint.eval_rho(mol_geo, phiCH3, DaCH3, xctype='gga')
nbCH3 = dft.numint.eval_rho(mol_geo, phiCH3, DbCH3, xctype='gga')
naCH4 = dft.numint.eval_rho(mol_geo, phiCH4, DaCH4, xctype='gga')
nbCH4 = dft.numint.eval_rho(mol_geo, phiCH4, DbCH4, xctype='gga')
...
exc, vxc, fxc, kxc = dft.libxc.eval_xc('pbe,pbe', ntot, spin=1, relativity=0, deriv=1, omega=None, verbose=None)
Exctot = np.sum((nfa[0]+nfb[0])*w * exc)
exc1, vxc1, fxc1, kxc1 = dft.libxc.eval_xc('pbe,pbe', n1, spin=1, relativity=0, deriv=1, omega=None, verbose=None)
ExcCH1 = np.sum((naCH1[0]+nbCH1[0])*w * exc1)
exc2, vxc2, fxc2, kxc2 = dft.libxc.eval_xc('pbe,pbe', n2, spin=1, relativity=0, deriv=1, omega=None, verbose=None)
ExcCH2 = np.sum((naCH2[0]+nbCH2[0])*w * exc2)
exc3, vxc3, fxc3, kxc3 = dft.libxc.eval_xc('pbe,pbe', n3, spin=1, relativity=0, deriv=1, omega=None, verbose=None)
ExcCH3 = np.sum((naCH3[0]+nbCH3[0])*w * exc3)
exc4, vxc4, fxc4, kxc4 = dft.libxc.eval_xc('pbe,pbe', n4, spin=1, relativity=0, deriv=1, omega=None, verbose=None)
