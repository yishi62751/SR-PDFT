...
CH1dft = FragmentDFT(CH1_geo, 'scan')
CH1dft.kernel()
...
unit='ANG', basis={'C': basis, 'ghost-C': ghostbasis, 'H': basis, 'ghost-H': ghostbasis}, spin=3)  
CH2dft = FragmentDFT(CH2_geo, 'scan')
CH2dft.kernel()
...
unit='ANG', basis={'C': basis, 'ghost-C': ghostbasis, 'H': basis, 'ghost-H': ghostbasis}, spin=3) 
CH3dft = FragmentDFT(CH3_geo, 'scan')
CH3dft.kernel()
...
unit='ANG', basis={'C': basis, 'ghost-C': ghostbasis, 'H': basis, 'ghost-H': ghostbasis}, spin=3) 
CH4dft = FragmentDFT(CH4_geo, 'scan')
CH4dft.kernel()
...
exc, vxc, fxc, kxc = dft.libxc.eval_xc('scan', ntot, spin=1, relativity=0, deriv=1, omega=None, verbose=None)
Exctot = np.sum((nfa[0]+nfb[0])*w * exc)
exc1, vxc1, fxc1, kxc1 = dft.libxc.eval_xc('scan', n1, spin=1, relativity=0, deriv=1, omega=None, verbose=None)
ExcCH1 = np.sum((naCH1[0]+nbCH1[0])*w * exc1)
exc2, vxc2, fxc2, kxc2 = dft.libxc.eval_xc('scan', n2, spin=1, relativity=0, deriv=1, omega=None, verbose=None)
ExcCH2 = np.sum((naCH2[0]+nbCH2[0])*w * exc2)
exc3, vxc3, fxc3, kxc3 = dft.libxc.eval_xc('scan', n3, spin=1, relativity=0, deriv=1, omega=None, verbose=None)
ExcCH3 = np.sum((naCH3[0]+nbCH3[0])*w * exc3)
exc4, vxc4, fxc4, kxc4 = dft.libxc.eval_xc('scan', n4, spin=1, relativity=0, deriv=1, omega=None, verbose=None)
